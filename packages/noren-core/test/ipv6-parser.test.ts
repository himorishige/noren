...
describe('IPv6 Parser', () => {
  describe('parseIPv6', () => {
    ...
    it('should handle IPv6 with embedded IPv4', () => {
      const cases = ['::ffff:192.168.1.1', '::192.168.1.1', '64:ff9b::192.0.2.1']
  ...
  describe('validateIPv6Candidates', () => {
    it('should validate and filter IPv6 candidates', () => {
      const candidates = ['2001:db8::1', 'invalid::address::here', 'fe80::1', '192.168.1.1', '::1']

      const results = validateIPv6Candidates(candidates)

      expect(results).toHaveLength(3)
      expect(results.map((r) => r.original)).toEqual(['2001:db8::1', 'fe80::1', '::1'])
