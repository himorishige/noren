...
export const DETECTION_PATTERNS = {
  ...
  ipv6: /(?:^|[\s(])([0-9A-F]{1,4}:[0-9A-F]{1,4}::[0-9A-F]{1,4}|(?:[0-9A-F]{1,4}:){7}[0-9A-F]{1,4}|(?:[0-9A-F]{1,4}:){1,6}::|::(?:[0-9A-F]{1,4}:){1,6}[0-9A-F]{1,4}|::)(?=[\s)]|$)/gi,
...
export const UNIFIED_PATTERN = new RegExp(
  [
    ...
    // Group 4: IPv6 (updated pattern to handle compressed notation)
    '|(?:^|[\\s(])([0-9A-F]{1,4}:[0-9A-F]{1,4}::[0-9A-F]{1,4}|(?:[0-9A-F]{1,4}:){7}[0-9A-F]{1,4}|(?:[0-9A-F]{1,4}:){1,6}::|::(?:[0-9A-F]{1,4}:){1,6}[0-9A-F]{1,4}|::)(?=[\\s)]|$)',
